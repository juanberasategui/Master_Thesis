...
- Feel free to use any of the files, but make sure to citate the work.

### Contact
- You can contact me at juan.gallego@student.nhh.no

### Citing the work

@masterthesis{citation-key,
    author = {Juan Berasategui Gallego} ,
    title = {Empirical Asset Pricing via Neural Networks and Macroeconomic Data},
